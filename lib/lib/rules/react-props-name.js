...
module.exports = {
    ...
    meta: {
        docs: {
            description: "React functional Component which have props that should name `Props`",
            recommended: true,
        },
        messages: {
            reactPropsName: "React functional Component which have props that should name `Props`",
        },
        type: "suggestion",
        schema: [],
    },
