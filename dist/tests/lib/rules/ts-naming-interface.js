...
const ts_naming_interface_js_1 = __importDefault(require("../../../lib/rules/ts-naming-interface.js"));
// Set up cleanup after tests are done
rule_tester_1.RuleTester.afterAll = mocha.after;
const ruleTester = new rule_tester_1.RuleTester();
ruleTester.run("타입스크립트 네이밍:인터페이스 정의", ts_naming_interface_js_1.default, {
